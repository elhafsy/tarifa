...
export default function App() {
  ...
  const [nombreAnne, setNombreAnne] = useState(1);
  const [firstYear, setFirstYear] = useState(2022);
  const [tarifUnitaire, setTarifUnitaire] = useState(6);
  ...
  // const tarif = useMemo(() => surface * 6, [surface]);
  const tarif = useMemo(() => surface * tarifUnitaire, [surface, tarifUnitaire]);
          ...
          <div className="lg:col-span-1 space-y-4">
            <Card className="shadow-lg border-0">
              ...
              <CardContent className="space-y-6 p-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="tarifUnitaire" className="text-sm font-semibold text-gray-700">
                    Tarif unitaire (DH / m²)
                  </Label>
                  <Input
                    id="tarifUnitaire"
                    ...
                    className="h-11 border-gray-300 focus:border-blue-500 focus:ring-blue-500"
                    placeholder="Entrez le tarif unitaire"
                  />
                </div>
